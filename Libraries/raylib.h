...
typedef enum {
    ...
    BLEND_CUSTOM                    // Belnd textures using custom Sources/dst factors (use rlSetBlendMode())
} BlendMode;
...
RLAPI Color ColorAlphaBlend(Color dst, Color src, Color tint);              // Get Sources alpha-blended into dst color with tint
